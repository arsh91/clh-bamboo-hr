			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sigma-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<a href="{{ url('/')}}" class="mb-12">
						<img alt="Logo" src="{{asset('assets/media/xtremeOtherLogo/XTREME DIGITAL FOR MUSIC.png')}}" class="h-40px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper--> 
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" action="{{ route('forgot.password') }}" method="post">
